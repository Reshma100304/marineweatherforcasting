...
**Marine Weather Forecaster** is an interactive prediction dashboard built for sailors, mariners, and marine researchers. It fetches live oceanic data from the [StormGlass API](https://stormglass.io/)and runs it through a pre-trained scikit-learn classifier to label current sea conditions.
...
- 🌐 **Live Data** — Pulls real marine forecast
